  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        setErrorMsg(
          isRtl
            ? 'خطأ في تسجيل الدخول. يرجى التحقق من البيانات وكلمة المرور.'
            : 'Login failed. Please check your credentials and password.'
        );
      ...
      <div className="w-full max-w-md bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-xs mt-1.5 leading-relaxed">
            {isRtl
              ? 'أدخل بريدك الإلكتروني أو رقم الهاتف وكلمة المرور'
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          ...
          <a href="/register" className="text-teal-600 font-bold hover:underline">
            {t('registerNow')}
          </a>
        </p>
